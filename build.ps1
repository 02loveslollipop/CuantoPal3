...
Write-Host "Done! The React app has been built."
...
Write-Host "Done! The Capacitor android project has been updated."
...
Write-Host "Done! The Capacitor ios project has been updated."
